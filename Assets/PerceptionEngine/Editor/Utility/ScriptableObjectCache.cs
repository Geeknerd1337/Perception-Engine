...
using Perception.Editor;

namespace Perception.Editor.Utility
{
    /// <summary>
    /// A cache for dynamically generated ScriptableObjects.
    /// </summary>
    internal static class ScriptableObjectCache
    {
        private const string AssemblyName = "Perception.DynamicAssembly";
